				...
				<div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="widget clearfix">
                        ...
                        <li><a href="../index.php">Home <span class="icon icon-arrow-right2"></span></a></li>
							...
							<li><a href="services.php">Services <span class="icon icon-arrow-right2"></span></a></li>
							<li><a href="contact.php">Contact us <span class="icon icon-arrow-right2"></span></a></li>
                        </ul><!-- end links -->
                    </div><!-- end clearfix -->
                </div><!-- end col -->
